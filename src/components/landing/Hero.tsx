...
export function Hero() {
  ...
  return (
    <section className="relative text-white flex items-center justify-center text-center min-h-[450px] md:min-h-[600px] py-16 md:py-24 overflow-hidden clip-path-bottom-diag">
