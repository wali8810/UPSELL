...
export function Hero() {
  ...
  return (
    <section className="relative text-white flex items-center justify-center text-center min-h-[450px] md:min-h-[600px] pt-16 md:pt-24 pb-32 md:pb-48 overflow-hidden clip-path-bottom-diag">
