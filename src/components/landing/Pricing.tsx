        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 max-w-5xl mx-auto">
          ...
          <div className="w-full md:w-1/2 flex">
             <div className="bg-white text-black rounded-2xl shadow-lg flex flex-col h-full border-2 border-gray-200 p-6 md:p-8 w-full">
                ...
                <div className="mt-auto">
                   <a href="https://pay.hotmart.com/D101925163B?off=ysxqko2h&bid=1757992676281" rel="noopener noreferrer" className="block w-full">
          ...
          <div className="w-full md:w-1/2 flex">
            ...
            >
              ...
              <Image src="https://i.imgur.com/DJUDH2b.png" alt="Mockup plano completo" width={400} height={300} className="w-full h-auto rounded-md my-4" data-ai-hint="course mockup bundle" priority/>
