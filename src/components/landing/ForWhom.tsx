...
const whatYouGetItems = [
    ...
    },
    {
        ...
        description: "de até 312%, criando produtos que custam menos de €1,50 para fazer e são vendidos por €5, €10 ou mais."
    },
    {
        icon: "✅",
        ...
        <>
            <section className="relative w-full pb-10 overflow-hidden text-white pt-12 md:pt-20 bg-gray-900">
              <div className="relative container mx-auto px-4 text-center z-10">
                ...
                ESPERE! <span className="text-destructive">O Seu Pedido Está Incompleto.</span>
                </h1>
                ...
                <div className="mt-8 flex justify-center">
                 ...
                 <div className="mt-8">
                    <a href="#plans" className="inline-block">
                        <Button size="lg" className="bg-green-500 hover:bg-green-600 text-white font-bold text-xl md:text-2xl h-auto py-4 px-10 rounded-lg shadow-lg animate-pulse-green">
