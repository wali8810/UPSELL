        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-16 text-center max-w-3xl mx-auto">
              <div className="text-lg text-left text-foreground/90 leading-relaxed space-y-4">
                  <p>Imagina você faturar até <strong style={{color: '#4fc700'}}>R$5.000,00 por mês</strong> apenas criando cartões decorativos em casa? Com meu método, você não precisa investir quase nada em materiais, e já no primeira semana você pode alcançar esse resultado.</p>
